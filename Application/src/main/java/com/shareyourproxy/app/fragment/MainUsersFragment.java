 ...
 */
public class MainUsersFragment extends BaseFragment implements ItemClickListener {
    @InjectView(R.id.fragment_user_display_recyclerview)
    protected BaseRecyclerView recyclerView;
    @InjectView(R.id.fragment_user_display_recyclerview_swipe_refresh)
    ...
    OnRefreshListener _refreshListener = new OnRefreshListener() {
        ...
        public void onRefresh() {
            recyclerView.post(new Runnable() {
                @Override
                public void run() {
                    _downloadUsersSubscription = bindFragment(MainUsersFragment.this,
     ...
     */
    public static MainUsersFragment newInstance() {
        return new MainUsersFragment();
    }

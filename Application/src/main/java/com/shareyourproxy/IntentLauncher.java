...
import static com.shareyourproxy.Constants.ARG_MAINFRAGMENT_SELECTED_TAB;
...
import static com.shareyourproxy.Intents.ACTION_ADD_CHANNEL_LIST_VIEW;
import static com.shareyourproxy.Intents.ACTION_EDIT_GROUP_CHANNEL;
import static com.shareyourproxy.Intents.ACTION_LOGIN;
import static com.shareyourproxy.Intents.ACTION_MAIN_VIEW;
import static com.shareyourproxy.Intents.ACTION_SEARCH_VIEW;
import static com.shareyourproxy.Intents.ACTION_VIEW_ABOUT;
import static com.shareyourproxy.Intents.ACTION_VIEW_GROUP_USERS;
...
public final class IntentLauncher {
    ...
    public static void launchAboutActivity(Activity activity) {
        Intent intent = new Intent(ACTION_VIEW_ABOUT);
    ...
    public static void launchChannelListActivity(Activity activity) {
        Intent intent = new Intent(ACTION_ADD_CHANNEL_LIST_VIEW);
        activity.startActivity(intent);
        activity.overridePendingTransition(R.anim.slide_in_bottom, R.anim.fade_out);
    }
    ...
    public static void launchEditGroupChannelsActivity(
        Activity activity, Group group, EditGroupChannelsActivity.GroupEditType groupEditType) {
        Intent intent = new Intent(ACTION_EDIT_GROUP_CHANNEL);
    ...
    public static void launchEditGroupContactsActivity(Activity activity, Group group) {
        Intent intent = new Intent(ACTION_VIEW_GROUP_USERS);
        intent.putExtra(ARG_SELECTED_GROUP, group);
        activity.startActivity(intent);
        activity.overridePendingTransition(R.anim.slide_in_bottom, R.anim.fade_out);
    }
    ...
    public static void launchIntroductionActivity(Activity activity) {
        Intent intent = new Intent(Intents.ACTION_INTRODUCTION).addFlags(
    ...
    public static void launchLoginActivity(Activity activity) {
        Intent intent = new Intent(ACTION_LOGIN).addFlags(FLAG_ACTIVITY_CLEAR_TOP);
        activity.startActivity(intent);
    }
    ...
    public static void launchMainActivity(
        ...
        Intent intent = new Intent(ACTION_MAIN_VIEW).addFlags(FLAG_ACTIVITY_CLEAR_TOP);
    ...
    public static void launchSearchActivity(
        ...
        Intent intent = new Intent(ACTION_SEARCH_VIEW);

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            View statusbar = activity.findViewById(android.R.id.statusBarBackground);
            View actionbar = activity.findViewById(android.R.id.navigationBarBackground);

            Pair<View, String> pair1 = create(textView, textView.getTransitionName());
            Pair<View, String> pair2 = create(menu, menu.getTransitionName());
            Pair<View, String> pair3 = create(container, container.getTransitionName());
            Pair<View, String> pair4 = create(statusbar, STATUS_BAR_BACKGROUND_TRANSITION_NAME);
            Pair<View, String> pair5 = create(actionbar, NAVIGATION_BAR_BACKGROUND_TRANSITION_NAME);

            ActivityOptionsCompat options = makeSceneTransitionAnimation(activity, pair1, pair2, pair3, pair4, pair5);
    ...
    public static void launchUserProfileActivity(
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            Pair<View, String> pair1 = create(profileImage, profileImage.getTransitionName());
            Pair<View, String> pair2 = create(userName, userName.getTransitionName());
            Pair<View, String> pair3 = create(statusbar, STATUS_BAR_BACKGROUND_TRANSITION_NAME);
            Pair<View, String> pair4 = create(actionbar, NAVIGATION_BAR_BACKGROUND_TRANSITION_NAME);
    ...
    public static void launchAddressIntent(Activity activity, String actionAddress) {
        ...
        Intent intent = new Intent(ACTION_VIEW, parse(sb.toString()));
    ...
    public static void launchEmailIntent(Activity activity, String address) {
        ...
        intent.putExtra(EXTRA_EMAIL, new String[]{ address });
        if (intent.resolveActivity(activity.getPackageManager()) != null) {
            activity.startActivity(intent);
        }
    }
    ...
    public static void launchHangoutsIntent(Activity activity, String actionAddress) {
        ...
        Intent intent = new Intent(ACTION_SENDTO, parse(sb.toString()));

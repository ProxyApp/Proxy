...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    public interface DismissCallbacks {
        ...
        /**
         * Called on touch down/up to indicate the {@link SnackBar} dismissal timer should or should
         * not pause when the user is swiping the snack bar away.
         *
    ...
    /**
     * Constructs a new swipe-to-dismissSnackBarAnimation touch listener for the given view.
     *
     * @param view      The view to make dismissable.
     * @param token     An optional token/cookie object to be passed through to the callback.
     * @param callbacks The callback to trigger when the user has indicated that she would like to
     *                  dismissSnackBarAnimation this view.
     */
    ...
    private void actionUp(View view, MotionEvent motionEvent) {
        ...
        mVelocityTracker.addMovement(motionEvent);
        mVelocityTracker.computeCurrentVelocity(ONE_THOUSAND);
        ...
        if ((int) Math.abs(deltaX) > mViewWidth / 2 && mSwiping) {
            ...
            // dismissSnackBarAnimation only if flinging in the same direction as dragging

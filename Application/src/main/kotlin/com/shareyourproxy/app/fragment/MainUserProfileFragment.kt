...
import com.shareyourproxy.R.dimen.fragment_userprofile_header_user_background_size
...
internal final class MainUserProfileFragment private constructor() : UserProfileFragment() {
    ...
    private val marginUserHeight: Int by bindDimen(fragment_userprofile_header_user_background_size)
    ...
    private val onClickShare: View.OnClickListener = View.OnClickListener {
        ShareLinkDialog.show(activity.supportFragmentManager,loggedInUser.groups)
    }
